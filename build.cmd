...
rem
pushd angle
rem Enable Vulkan support and keep OpenGL for OpenGL-to-Vulkan translation
call gn gen out/%ARCH% --args="target_cpu=""%ARCH%"" angle_build_all=false is_debug=false angle_has_frame_capture=false angle_enable_gl=true angle_enable_vulkan=true angle_enable_wgpu=false angle_enable_d3d9=false angle_enable_null=false use_siso=false" || exit /b 1
...
rem Include Vulkan headers if they exist
xcopy /D /S /I /Q /Y angle\include\vulkan angle-%ARCH%\include\vulkan 1>nul 2>nul
